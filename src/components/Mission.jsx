  ...
  return (
    <div className=' px-4 md:px-16 py-20 grid md:grid-cols-5 gap-8'>
      <div className='md:col-span-2 grid gap-4'>
        ...
        <p className=' text-lg  text-gray-600 md:pr-8 '> Our mission is to redefine the future through technology. Believing in the power of innovation, we strive to create solutions that matter, going beyond boundaries. Our commitment is rooted in a shared vision – shaping a 
