...
function About() {
  return (
    <div className='grid md:grid-cols-2 md:py-20 py-8 md:px-16 px-4 gap-8 items-center'>
      <div className='px-4 md:w-3/4 md:py-8'>
        ...
        <p className='text-2xl mt-8 md:mt-4'>
      ...
      <div>
        <img className='md:w-3/4 rounded-xl' src = {Aboutimage} alt="" />
      </div>
    </div>
  )
}
